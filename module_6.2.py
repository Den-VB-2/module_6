...
class Vehicle:
    ...
    def __init__(self, owner, __model, __engine_power, __color):
        ...
        self.__model = str(__model) # модель(марка) транспорта (мы не можем менять)
        self.__engine_power = int(__engine_power) # мощность двигателя (мы не можем менять)
        self.__color = str(__color) # название цвета (мы  не можем менять, сравнить со списком)
...
class Sedan(Vehicle):
    __PASSENGERS_LIMIT = 5 # не на что не влияет в данной задаче, можно было просто поставить "pass"
